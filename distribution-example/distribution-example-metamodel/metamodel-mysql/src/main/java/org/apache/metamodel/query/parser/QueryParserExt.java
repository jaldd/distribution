 ...
 */
public class QueryParserExt {

    private final DataContext _dataContext;
    private final String _queryString;
    private final String _queryStringUpperCase;

    public QueryParserExt(DataContext dataContext, String queryString) {
        if (dataContext == null) {
    ...
    private void parseFromClause(Query query, String fromClause) {
        // modify by xinzp 2021-05-12 允许支持AS关键
//        QueryPartParser clauseParser = new QueryPartParser(new FromItemParserExt(_dataContext, query), fromClause, ",");
    ...
    private void parseSelectClause(Query query, String selectClause) {
        // modify by xinzp 2021-05-12 允许支持表达式和函数 AS关键字
        QueryPartParser clauseParser = new QueryPartParser(new SelectItemParserExt(query, true), selectClause, ",");
        clauseParser.parse();
    }
