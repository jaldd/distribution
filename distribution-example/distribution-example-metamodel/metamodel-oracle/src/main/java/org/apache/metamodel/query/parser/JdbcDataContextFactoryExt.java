...
public class JdbcDataContextFactoryExt extends AbstractDataContextFactory {
    ...
    public DataContext create(DataContextProperties properties, ResourceFactoryRegistry resourceFactoryRegistry)
        ...
        if (dataSource != null) {
            return new JdbcDataContextExt(dataSource, tableTypes, catalogName);
        }
        ...
        return new JdbcDataContextExt(connection, tableTypes, catalogName);
    }
