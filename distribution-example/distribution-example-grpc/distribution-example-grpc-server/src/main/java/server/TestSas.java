...
public class TestSas {
    ...
    public static void main(String[] args) {
        JSONArray array = new TestSas().readSas(new File("C:\\Users\\lidd-h\\Downloads\\cfps2020person_202112.sas7bdat"), "formats_cfps_chinese.sas7bcat");
        JSONArray jsonArray = array.getJSONObject(0).getJSONArray("formats_cfps_chinese.sas7bcat");
